...
DEPENDS = "alsa-lib jack liblo libsndfile1 libsamplerate0"

SRC_URI = "http://ecasound.seul.org/download/ecasound-2.9.1.tar.gz"
...
EXTRA_OECONF = "--disable-pyecasound --disable-rubyecasound --disable-sys-readline"
